...
export class ButtonToggleComponent extends BaseControlValueAccessor<unknown[] | unknown> {
  ...
  private selectMulti(selected: unknown[], option: TOption<unknown>): unknown[] {
    let res = [...selected];
